...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBar.setStyleSheet("background-color:0; color: #ffdeda")
        self.progressBar.setProperty("value", 0)
        self.progressBar.setTextVisible(True)
        self.progressBar.setObjectName("progressBar")
        self.progress_goal = QtWidgets.QLabel(self.page_progress)
        self.progress_goal.setGeometry(QtCore.QRect(250, 170, 31, 51))
        font = QtGui.QFont()
        font.setPointSize(32)
        self.progress_goal.setFont(font)
        self.progress_goal.setStyleSheet("background-color:0; color: #ffdeda")
        self.progress_goal.setObjectName("progress_goal")
        self.bkgrnd_3.raise_()
        self.title_progress.raise_()
        self.progressBar.raise_()
        self.progress_goal.raise_()
        ...
        self.checkpoint_goal = QtWidgets.QLabel(self.page_checkpoint)
        self.checkpoint_goal.setGeometry(QtCore.QRect(260, 130, 31, 51))
        font = QtGui.QFont()
        font.setPointSize(32)
        self.checkpoint_goal.setFont(font)
        self.checkpoint_goal.setStyleSheet("background-color:0; color: #ffdeda")
        self.checkpoint_goal.setObjectName("checkpoint_goal")
...
"Timer"))
        ...
        self.progress_goal.setText(_translate("MainWindow", "0"))
        self.title_checkpoint.setText(_translate("MainWindow", "Choose Timer"))
        self.checkpoint_goal.setText(_translate("MainWindow", "0"))
