...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.welcome.setGeometry(QtCore.QRect(50, 30, 471, 181))
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(130, 370, 281, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.timeToGo = QtWidgets.QLabel(self.page_digital)
        self.timeToGo.setGeometry(QtCore.QRect(30, 160, 471, 151))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(102)
        self.timeToGo.setFont(font)
        self.timeToGo.setStyleSheet("background-color:0; color: #ffdeda")
        self.timeToGo.setAlignment(QtCore.Qt.AlignCenter)
        self.timeToGo.setObjectName("timeToGo")
        ...
        self.progressBar.setGeometry(QtCore.QRect(40, 140, 461, 21))
        ...
        self.congrats = QtWidgets.QLabel(self.page_done)
        self.congrats.setGeometry(QtCore.QRect(30, 10, 481, 151))
        font = QtGui.QFont()
        font.setFamily("Britannic Bold")
        font.setPointSize(51)
        self.congrats.setFont(font)
        self.congrats.setStyleSheet("background-color:0; color: #ffdeda")
        self.congrats.setAlignment(QtCore.Qt.AlignCenter)
        self.congrats.setObjectName("congrats")
        self.bkgrnd_4 = QtWidgets.QLabel(self.page_done)
        self.bkgrnd_4.setGeometry(QtCore.QRect(0, 0, 550, 440))
        self.bkgrnd_4.setText("")
        self.bkgrnd_4.setPixmap(QtGui.QPixmap("pixel.png"))
        self.bkgrnd_4.setObjectName("bkgrnd_4")
        self.congrats_2 = QtWidgets.QLabel(self.page_done)
        self.congrats_2.setGeometry(QtCore.QRect(40, 180, 481, 151))
        font = QtGui.QFont()
        font.setFamily("Britannic Bold")
        font.setPointSize(30)
        self.congrats_2.setFont(font)
        self.congrats_2.setStyleSheet("background-color:0; color: #ffdeda")
        self.congrats_2.setAlignment(QtCore.Qt.AlignCenter)
        self.congrats_2.setWordWrap(True)
        self.congrats_2.setObjectName("congrats_2")
        self.bkgrnd_4.raise_()
        self.congrats.raise_()
        self.congrats_2.raise_()
        self.pages.addWidget(self.page_done)
...
"Timer"))
        self.pushButton.setText(_translate("MainWindow", "START A TIMER"))
        self.title_digital.setText(_translate("MainWindow", "Focus Timer"))
        self.timeToGo.setText(_translate("MainWindow", "00:00"))
        self.title_progress.setText(_translate("MainWindow", "Focus Timer"))
        self.congrats.setText(_translate("MainWindow", "Yay!"))
        self.congrats_2.setText(_translate("MainWindow", "You completed your focus session!"))
